...
class help(commands.Cog):
  ...
  async def help(self, ctx):
    ...
    embed.add_field(name="`v!Moderation`", value="Shows moderation commands!", inline=True)
    embed.add_field(name="`v!Fun`", value="Shows fun commands!", inline=True)
    embed.add_field(name="`v!Utility`", value="Shows utility commands!", inline=True)
    embed.add_field(name="`v!Customs`", value="Shows the custom commads!", inline=True)
    embed.add_field(name="`v!Owner`", value="Shows owner commands!", inline=True)
  ...
  async def custom(self, ctx):
    ...
    embed.add_field(name="`v!Tinx`", value="Custom command for `⸸Tinx⸸#9999`!", inline=True)
    embed.add_field(name="Daddy", description="Custom command for `")
    embed.set_author(name=hashtag)
    embed.set_footer(text=f"Requested by {ctx.author}!")
    embed.set_thumbnail(url=ctx.author.avatar.url)
  ...
  async def moderation(self, ctx):
    ...
    embed.add_field(name="`Mute`", value="Mutes the specified user!")
  ...
  async def fun(self, ctx):
    ...
    embed.add_field(name="More #VarmonyOT", value="More #VarmonyOT", inline=True)
    embed.set_author(name=hashtag)
    embed.set_thumbnail(url=ctx.author.avatar.url)
    embed.set_footer(text=f"Requested By {ctx.author}")
  ...
  async def utility(self, ctx):
    ...
    embed.add_field(name="`Bug`", value="Sends a bug you found to the bot dev!", inline=True)
    embed.add_field(name="`Suggest`", value="Sends a suggestion you suggest to the bot dev!", inline=True)
    ...
    embed.add_field(name="`Say`", value="Says a specified message!")
    embed.set_author(name=hashtag)
    embed.set_thumbnail(url=ctx.author.avatar.url)
    embed.set_footer(text=f"Requested By {ctx.author}")
