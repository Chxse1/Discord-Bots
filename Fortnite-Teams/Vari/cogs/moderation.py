...
class moderation(commands.Cog):
  ...
  async def kick(self, ctx, member: discord.Member = None, *, reason:str=None):
    if member == None:
      embed=discord.Embed(title="Error", description="Please specify a user for me to kick!")
  ...
  async def ban(self, ctx, member: discord.Member = None, *, reason:str=None):
    if member == None:
      embed=discord.Embed(title="Error", description="Please specify a user for me to ban!")
      await ctx.message.reply(embed=embed)
    if reason == None:
      reason = "No Reason Provided"
  ...
  async def purge(self, ctx, limit: int=None):
      if limit == None:
        embed=discord.Embed(title="Error", description="Please specify an amount of messages to purge!")
        await ctx.message.reply(embed=embed)
      else:
